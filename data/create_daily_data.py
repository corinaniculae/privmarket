...
def main():
    ...
    tfl_manager = create_synthetic_data.TFLManager()
    ...
    try:
        ...
        create_table_query = (datalib.MYSQL_CREATE_TABLE % args.table)
        ...
        for file_name in files_to_be_added:
            source = (os.getcwd() + datalib.CSV_FOLDER + file_name)
            add_csv_query = (datalib.MYSQL_LOAD_FILE % source, args.table)
